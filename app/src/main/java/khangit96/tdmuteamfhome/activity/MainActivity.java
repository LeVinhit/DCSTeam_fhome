...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, OnMapReadyCallback {
    ...
    * */
    public void initDrawerLayout() {
        ...
        TextView tvAbout, tvFeedback, tvShare, tvHouseArea, tvSearchBHXH, tvLegalAdvice;
        ...
        //tvSearchBHXH = (TextView) MenuItemCompat.getActionView(navigationView.getMenu().findItem(R.id.menuSearchBHXH));
        //tvLegalAdvice = (TextView) MenuItemCompat.getActionView(navigationView.getMenu().findItem(R.id.menuLegalAdvice));
        ...
        //customMenuItemDrawer(tvSearchBHXH, "Tra cứu bảo hiểm xã hội", 90);
        //customMenuItemDrawer(tvLegalAdvice, "Tư vấn pháp luật", 90);
    ...
    public boolean onNavigationItemSelected(MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.menuFeedback:
                ...
                break;
            /*case R.id.menuSearchBHXH:
                startActivity(new Intent(MainActivity.this, SearchBHXHActivity.class));
                break;
            case R.id.menuLegalAdvice:
                startActivity(new Intent(MainActivity.this, LegalAdviceActivity.class));
                break;*/
        }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ...
                mMap.setMyLocationEnabled(true);
                showToast("Bạn đã cho phép ứng dụng truy cập vị trí.");
            }
        } else {
            mMap.setMyLocationEnabled(true);
        }
